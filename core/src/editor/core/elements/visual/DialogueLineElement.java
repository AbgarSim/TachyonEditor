 ...
 */
public class DialogueLineElement {
    ...
    public DialogueLineElement(Vector2 pos, DialogueLineModel model, MainScreen screen) {
        this(pos.x, pos.y, model, screen);
    }


    public DialogueLineElement(float posx, float posy, DialogueLineModel model, MainScreen screen) {
        this.parent = screen;
        this.model = model;
        ...
        addActorToStage(connectNextLineButton);
    }
    ...
    public void addReply() {
        replies.put(String.valueOf(counter), new DialogueReplyElement(new DialogueReplyModel(String.valueOf(counter++), "1234", "Lel", this.model), this));
    }
        ...
        class ConnectNextLineListener extends ClickListener {
            ...
            public boolean touchDown(InputEvent event, float x, float y, int pointer, int button) {
                if (DialogueLineElement.this.getParentScreen().isConnectArrowMode()) {
                    System.out.printf("Fired button");
